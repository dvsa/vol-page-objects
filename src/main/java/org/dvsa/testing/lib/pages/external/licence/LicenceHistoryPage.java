...
public class LicenceHistoryPage extends BasePage {
    ...
    public static void trafficAreasQ1(boolean answer) throws IllegalBrowserException {
        int position = Util.radioPosition(answer);
        click(String.format(QUESTION_1, position));
    }

    public static void trafficAreasQ2(boolean answer) throws IllegalBrowserException {
        int position = Util.radioPosition(answer);
        click(String.format(QUESTION_2, position));
    }

    public static void trafficAreasQ3(boolean answer) throws IllegalBrowserException {
        int position = Util.radioPosition(answer);
        click(String.format(QUESTION_3, position));
    }

    public static void EUQ1(boolean answer) throws IllegalBrowserException {
        int position = Util.radioPosition(answer);
        click(String.format(QUESTION_4, position));
    }

    public static void EUQ2(boolean answer) throws IllegalBrowserException {
        int position = Util.radioPosition(answer);
        click(String.format(QUESTION_5, position));
    }

    public static void publicInquiriesQ1(boolean answer) throws IllegalBrowserException {
        int position = Util.radioPosition(answer);
        click(String.format(QUESTION_6, position));
    }

    public static void assetsAndSharesQ1(boolean answer) throws IllegalBrowserException {
        int position = Util.radioPosition(answer);
