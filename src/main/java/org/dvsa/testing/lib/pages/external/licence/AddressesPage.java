...
public class AddressesPage extends BasePage {
    ...
    public static void findAddressForCorrespondence(@NotNull String postCode) throws UninitialisedDriverException {
        enterField(CORRESPONDENCE_POST_CODE_SEARCH, postCode);
        click(CORRESPONDENCE_FIND_ADDRESS_BUTTON, SelectorType.XPATH);
    }

    public static void contactNumber(@NotNull String number, @NotNull Phone phone) throws UninitialisedDriverException {
    ...
    public static void contactNumber(@NotNull String primaryNumber) throws UninitialisedDriverException {
        contactNumber(primaryNumber, Phone.PRIMARY);
    }

    public static void contactNumber(@NotNull String primaryNumber, @NotNull String secondaryNumber) throws UninitialisedDriverException {
        contactNumber(primaryNumber, Phone.PRIMARY);
    ...
    public static void findAddressForEstablishment(@NotNull String postCode) throws UninitialisedDriverException {
