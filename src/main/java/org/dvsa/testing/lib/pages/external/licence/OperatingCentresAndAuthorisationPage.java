...
public class OperatingCentresAndAuthorisationPage extends BasePage {
    ...
    // Behaviour
    public static void addOperatingCentre() throws MissingDriverException {
        click(ADD_OPERATING_CENTRE);
    }

    public static void desiredNumberOfVehiclesAuthorisedOnLicence(@NotNull int numberOfVehicles) throws MissingDriverException {
        enterField(DESIRED_NUMBER_OF_VEHICLES_AUTHORISED_ON_LICENCE, String.valueOf(numberOfVehicles));
    }

    public static void desiredNumberOfTrailersAuthorisedOnLicence(@NotNull int numberOfTrailers) throws MissingDriverException {
