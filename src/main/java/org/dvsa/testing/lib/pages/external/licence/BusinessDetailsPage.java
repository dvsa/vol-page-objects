...
public class BusinessDetailsPage extends BasePage {
    ...
    // Behaviour
    public static void companyLookup(@NotNull String name) throws MissingDriverException {
        enterField(COMPANY_LOOKUP_FIELD, name);
        click(FIND_COMPANY_BUTTON);
    }

    public static void tradingName(@NotNull String... names) throws MissingDriverException {
    ...
    public static void natureOfBusiness(@NotNull String natureOfBusiness) throws MissingDriverException {
        enterField(NATURE_OF_BUSINESS_FIELD, natureOfBusiness);
    }

    public static void address(@NotNull AddressLine addressLine, @NotNull String text) throws MissingDriverException {
        enterField(String.format(REGISTERED_ADDRESS_TEMPLATE, addressLine.ordinal()), text);
    }

    public static void addSubsidiary() throws MissingDriverException {
