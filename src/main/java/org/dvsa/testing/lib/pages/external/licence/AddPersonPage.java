...
public class AddPersonPage extends BasePage {
    ...
    // Behaviour
    public static void title(@NotNull Title title) throws UninitialisedDriverException {
        list(TITLE_LIST_TEMPLATE, title.ordinal() + 1);
    }

    public static void firstName(@NotNull String name) throws UninitialisedDriverException {
        enterField(FIRST_NAME_FIELD, name);
    }

    public static void lastName(@NotNull String name) throws UninitialisedDriverException {
        enterField(LAST_NAME_FIELD, name);
    }

    public static void otherName(@NotNull String name) throws UninitialisedDriverException {
        enterField(OTHER_NAME, name);
    }

    public static void dateOfBirth(@NotNull HashMap<Calendar, String> calendar) throws UninitialisedDriverException {
    ...
    public static void saveButton() throws UninitialisedDriverException {
        click(SAVE_BUTTON);
    }

    public static void calcelButton() throws UninitialisedDriverException {
        click(CANCEL_BUTTON);
    }
}
