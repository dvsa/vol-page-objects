...
public class AddPersonPage extends BasePage {
    ...
    // Behaviour
    public static void title(@NotNull Title title) throws IllegalBrowserException {
        list(TITLE_LIST_TEMPLATE, title.ordinal() + 1);
    }

    public static void firstName(@NotNull String name) throws IllegalBrowserException {
        enterField(FIRST_NAME_FIELD, name);
    }

    public static void lastName(@NotNull String name) throws IllegalBrowserException {
        enterField(LAST_NAME_FIELD, name);
    }

    public static void otherName(@NotNull String name) throws IllegalBrowserException {
        enterField(OTHER_NAME, name);
    }

    public static void dateOfBirth(@NotNull HashMap<Calendar, String> calendar) throws IllegalBrowserException {
    ...
    public static void saveButton() throws IllegalBrowserException {
        click(SAVE_BUTTON);
    }

    public static void calcelButton() throws IllegalBrowserException {
        click(CANCEL_BUTTON);
    }
}
