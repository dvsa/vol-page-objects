...
public class RegisterConfirmationPage extends BasePage {
    ...
    public static String getConfirmEmailTemppassSentMessageText() throws IllegalBrowserException {
        return getText(CONFIRM_EMAIL_TEMPPASS_SENT_MESSAGE, SelectorType.CSS);
    }

    public static String getEmailNotRecivevedMessage() throws IllegalBrowserException {
