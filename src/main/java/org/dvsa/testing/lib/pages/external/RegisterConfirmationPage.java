...
public class RegisterConfirmationPage extends BasePage {
    ...
    public static String getConfirmEmailTemppassSentMessageText() throws MissingDriverException {
        return getText(CONFIRM_EMAIL_TEMPPASS_SENT_MESSAGE, SelectorType.CSS);
    }

    public static String getEmailNotRecivevedMessage() throws MissingDriverException {
